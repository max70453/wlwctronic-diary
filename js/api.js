...
const mockData = {
    announcements: [
        {
            id: 'announcement1',
            title: 'Олимпиада',
            content: 'Уважаемые ученики! Приглашаем вас принять участие в олимпиаде по математике, которая состоится 15 февраля. Заявки принимаются до 10 февраля у вашего классного руководителя.',
            date: '2026-01-20',
            forClass: 'all'
        },
        {
            ...
            content: 'Уважаемые родители и ученики! Состоится родительское собрание 25 января в 18:00 в актовом зале. Приглашаются все желающие.',
            date: '2026-01-18',
            forClass: 'all'
        },
        {
            ...
            content: 'Уважаемые ученики! 30 января организуется экскурсия в Музей «Донбасс непокорённый». Стоимость билета 200 рублей. Запись у классного руководителя.',
            date: '2026-01-19',
            forClass: '10'
        }
    ],
    ...
    students: {
        'student1': {
            ...
            name: 'Иван Иванов',
            class: '3 ПО-21',
            adress: 'Площадь Свободы д. 12 кв. 9',
            email: 'ivan.ivanov@school.ru',
            phone: '+7 (999) 123-45-67',
            grades: [
                { subject: 'Математика', grade: 5, date: '2026-01-15', teacher: 'Пугачева О.М.', topic: 'Контрольная работа' },
                { subject: 'Математика', grade: 4, date: '2026-01-10', teacher: 'Пугачева О.М.', topic: 'Домашняя работа' },
                { subject: 'Математика', grade: 5, date: '2026-01-08', teacher: 'Пугачева О.М.', topic: 'Самостоятельная работа' },
                { subject: 'Русский язык', grade: 5, date: '2026-01-12', teacher: 'Горбунь Н.И.', topic: 'Сочинение' },
                { subject: 'Русский язык', grade: 4, date: '2026-01-09', teacher: 'Горбунь Н.И.', topic: 'Диктант' },
                { subject: 'Обесп. без. веб-прил', grade: 4, date: '2026-01-14', teacher: 'Демишева Е.Н.', topic: 'Лабораторная работа' },
                { subject: 'WEB-программирование', grade: 5, date: '2026-01-18', teacher: 'Сугоняко Н. В.', topic: 'Практическая работа' },
                { subject: 'Оптимизация веб-прил', grade: 4, date: '2026-01-04', teacher: 'Малик Я.Ю.', topic: 'Практическая работа' },
                { subject: 'Физика', grade: 5, date: '2026-01-11', teacher: 'Столярова Ю. Б.', topic: 'Домашняя работа' },
                { subject: 'Менеджмент', grade: 5, date: '2026-01-13', teacher: 'Максецкая С.С.', topic: 'Устный ответ' },
                { subject: 'История', grade: 3, date: '2026-01-07', teacher: 'Липник Е.Ф.', topic: 'Устный ответ' },
                { subject: 'Английский язык', grade: 4, date: '2026-01-16', teacher: 'Кобылянская А.Н.', topic: 'Устный ответ' },
                { subject: 'Английский язык', grade: 5, date: '2026-01-06', teacher: 'Кобылянская А.Н.', topic: 'Самостоятельная работа' },
                { subject: 'Биология', grade: 3, date: '2026-01-17', teacher: 'Мачкарина Е.Б.', topic: 'Контрольная работа' },
                { subject: 'Биология', grade: 4, date: '2026-01-05', teacher: 'Мачкарина Е.Б.', topic: 'Лабораторная работа' },
                { subject: 'Химия', grade: 4, date: '2026-01-19', teacher: 'Поплавска Е.Ф.', topic: 'Практическая работа' },
                { subject: 'Химия', grade: 3, date: '2026-01-03', teacher: 'Поплавска Е.Ф.', topic: 'Лабораторная работа' },
                { subject: 'Информатика', grade: 5, date: '2026-01-20', teacher: 'Надеева Е.А.', topic: 'Экзамен' },
                { subject: 'Информатика', grade: 5, date: '2026-01-02', teacher: 'Надеева Е.А.', topic: 'Зачет' },
                { subject: 'География', grade: 4, date: '2026-01-21', teacher: 'Кулик И.И.', topic: 'Зачет' },
                { subject: 'География', grade: 4, date: '2026-01-01', teacher: 'Кулик И.И.', topic: 'Зачет' }
            ],
            attendance: [
