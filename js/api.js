...
const mockData = {
    ...
    students: {
        'student1': {
            ...
            grades: [
                { subject: 'Математика', grade: 5, date: '2026-01-15', teacher: 'Иванов И.И.', topic: 'Контрольная работа' },
                { subject: 'Математика', grade: 4, date: '2026-01-10', teacher: 'Иванов И.И.', topic: 'Домашняя работа' },
                { subject: 'Математика', grade: 5, date: '2026-01-08', teacher: 'Иванов И.И.', topic: 'Самостоятельная работа' },
                { subject: 'Русский язык', grade: 5, date: '2026-01-12', teacher: 'Петрова П.П.', topic: 'Сочинение' },
                { subject: 'Русский язык', grade: 4, date: '2026-01-09', teacher: 'Петрова П.П.', topic: 'Диктант' },
                { subject: 'Физика', grade: 4, date: '2026-01-14', teacher: 'Сидоров С.С.', topic: 'Лабораторная работа' },
                { subject: 'Физика', grade: 5, date: '2026-01-11', teacher: 'Сидоров С.С.', topic: 'Тест' },
                { subject: 'История', grade: 5, date: '2026-01-13', teacher: 'Кузнецова К.К.', topic: 'Тест по истории' },
                { subject: 'История', grade: 3, date: '2026-01-07', teacher: 'Кузнецова К.К.', topic: 'Устный ответ' },
                { subject: 'Английский язык', grade: 4, date: '2026-01-16', teacher: 'Смирнова С.С.', topic: 'Устный ответ' },
                { subject: 'Английский язык', grade: 5, date: '2026-01-06', teacher: 'Смирнова С.С.', topic: 'Проект' },
                { subject: 'Биология', grade: 3, date: '2026-01-17', teacher: 'Попов П.П.', topic: 'Контрольная работа' },
                { subject: 'Биология', grade: 4, date: '2026-01-05', teacher: 'Попов П.П.', topic: 'Лабораторная работа' },
                { subject: 'Литература', grade: 5, date: '2026-01-18', teacher: 'Васильева В.В.', topic: 'Анализ произведения' },
                { subject: 'Литература', grade: 4, date: '2026-01-04', teacher: 'Васильева В.В.', topic: 'Эссе' },
                { subject: 'Химия', grade: 4, date: '2026-01-19', teacher: 'Лебедева Л.Л.', topic: 'Практическая работа' },
                { subject: 'Химия', grade: 3, date: '2026-01-03', teacher: 'Лебедева Л.Л.', topic: 'Тест' },
                { subject: 'Информатика', grade: 5, date: '2026-01-20', teacher: 'Тихонов Т.Т.', topic: 'Экзамен' },
                { subject: 'Информатика', grade: 5, date: '2026-01-02', teacher: 'Тихонов Т.Т.', topic: 'Алгоритмы' },
                { subject: 'География', grade: 4, date: '2026-01-21', teacher: 'Морозов М.М.', topic: 'Картографическая работа' },
                { subject: 'География', grade: 4, date: '2026-01-01', teacher: 'Морозов М.М.', topic: 'Зачет' }
            ],
            attendance: [
